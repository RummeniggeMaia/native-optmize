...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" style="background-color:white" class="form-control" id="ctr" value="@If(count($clicks) > 0){{ number_format($impressions / count($clicks), 2) }}@else 0.00 @endif" readonly>
        </div>
    </div>
    <div class="form-group">
